...
func TestScoreAccount(t *testing.T) {
	...
	tests := []struct {
		...
		{"fable window is ignored in sustained rank", map[string]float64{"five_hour": 100, "seven_day": 80, "seven_day_fable": 5}, false, 20, 16},
		{"exhausted fable alone does not gate the account", map[string]float64{"five_hour": 100, "seven_day": 80, "seven_day_fable": 0.5}, false, 20, 16},
	}
